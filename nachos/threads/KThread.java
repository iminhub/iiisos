...
public class KThread {
	...
	//ThreadedKernel.scheduler.letItDie(currentThread);
	//if(currentThread.schedulingState != null) {
		//for(int i = 0; i < ((ThreadState)(currentThread.schedulingState)).donateTo.size(); i++) {
			//ThreadState ts = ThreadedKernel.scheduler.getThreadState(ThreadedKernel.scheduler.getThreadState(currentThread).donateTo.get(i));
			//ts.getFrom.r
