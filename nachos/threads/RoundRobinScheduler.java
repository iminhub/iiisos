...
public class RoundRobinScheduler extends Scheduler {
    ...
    public void letItDie(KThread thread) {
	...
	//public class MyClass extends LinkedList {
	//	public KThread current = null;
	//	public MyClass(){};
	//}

	private LinkedList<KThread> waitQueue = new LinkedList<KThread>();
	//private MyClass<KThread> waitQueue = new MyClass<KThread>();
    }
}
